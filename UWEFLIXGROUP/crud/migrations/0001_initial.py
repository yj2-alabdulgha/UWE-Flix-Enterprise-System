    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('club', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crud.club')),
            ],
        ),
        migrations.AddField(
            model_name='club',
            name='representative',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crud.representative'),
        ),
    ]
